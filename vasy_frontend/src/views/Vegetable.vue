<template>
  ...
  <img
    class="rounded-circle kurashiru-logo mt-5"
    alt="Kurashiru logo"
    src="@/assets/kurashiru.png"
  />
  <div class="container" v-cloak>
    ...
    <img
      class="rounded-circle cookpad-logo w-25 h-25 mt-5"
      alt="Cookpad logo"
      src="@/assets/cookpad.png"
    />
...
export default {
  ...
  mounted() {
    ...
    axios
      ...
      .then((response) => {
        this.cookpad_datas = response.data[2];
      })
      .catch((error) => console.log(error));
  },
};
